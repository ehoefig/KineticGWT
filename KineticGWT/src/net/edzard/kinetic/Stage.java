...
public class Stage extends Container {
	 ...
	 */
	public final Transition transitionTo(Stage target, int duration) {
	...
	public final Transition transitionTo(Stage target, int duration, EasingFunction ease, Runnable callback) {

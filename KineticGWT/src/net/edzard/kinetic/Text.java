...
public class Text extends Shape {
	 ...
	 */
	public final Transition transitionTo(Text target, int duration) {
	 ...
	 * @return An object for controlling the transition.
	 */
	public final Transition transitionTo(Text target, int duration, EasingFunction ease, Runnable callback) {
